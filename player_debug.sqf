...
/*-----------*/	_DebugText = _DebugText + format ["<t size='1' font='Zeppelin33' align='left' color='#CCCCCC'>%1</t><br/>", _spacer];
	...
	_DebugText = _DebugText + format ["<t size='1.2' font='Zeppelin33' align='left' color='#D0F000'>Bank: </t><t size='1.2' font='Zeppelin33' align='right' color='#FFFFFF'>%1</t><br/>", [player getVariable["bankhMoney",0]] call BIS_fnc_numberText]; 
/*-----------*/	_DebugText = _DebugText + format ["<t size='1' font='Zeppelin33' align='left' color='#CCCCCC'>%1</t><br/>", _spacer];
